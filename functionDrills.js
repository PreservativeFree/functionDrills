...
*/
let associateName = "Cameron"
function printName (associateName) {
  console.log(`The person's name is ${associateName}`);
}
printName(associateName);
...
*/
let sum;
const add = function(args1, args2) {
  let val1 = Number(args1);
  let val2 = Number(args2);
  return args1 + args2;
}
sum = add(10, 12);
console.log(sum);
...
const nameCheck = function(nameOne) {
  if(nameOne == "Steven") {
      return 'What is up Steven?';
  } else if(nameOne == "Bryan") {
      return 'Hey Bryan!';
  } else
      return `Cool name, ${nameOne}`;
}

var nameGreeting = nameCheck("Steven");
...
const printAllNames = function(arrayNames) {
...
const theEliminator = function(contestants, contestantOne) {
  for(let i = 0; i < contestants.length; i++) {
    if(contestants[i] == contestantOne) {
...
const upperCaseFunction = function(myString) {
  let newString = myString.toUpperCase();
  return newString;
}
console.log(upperCaseFunction(sampleString));
...
const emailCheck = function(myEmailParam) {
  let newEmail = myEmailParam.trim();
...
console.log(emailCheck('  waterarrow@yahoo.com  '));
////////////////// PROBLEM 19 ////////////////////
/*
  Write a function, naming it whatever you believe to be appropriate, that buys as many chocolate frogs as 
  possible with a certain amount of gold. Each chocolate frog costs 3 gold. 
...
const chocolateFrogPurchase = function(submitGold) {
  let totalFrogs = submitGold/3;
  return totalFrogs;
}

console.log(chocolateFrogPurchase(120));
...
const chocolateFrogPurchase2 = function(submitGold) {
  let totalFrogs2 = Math.floor(submitGold/3);
  return totalFrogs2;
}
console.log(chocolateFrogPurchase2(4));

////////////////// PROBLEM 21 ////////////////////
let sampleArray = [0,1,2,3,4,7,3,5,8,9]
/*
  ...
  if it is sorted in ascending order, false if it is not. Create a variable, `arrayIsAscending` and set 
  it equal to your function invoked. Use the sample array to test this function.
*/
let isAscending = true;
const arrayAscending = function(myArray) {
    for(let i = 0; i < myArray.length; i++) {
        for(let y = i+1; y < myArray.length; y++) {
...
let arrayIsAscending = arrayAscending(sampleArray);
